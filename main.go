...
import (
	...
	"github.com/gregory-m/udm-local-dns/config"
	"github.com/gregory-m/udm-local-dns/dnsmasq"
)
...
var configFile = flag.String("config", "local-dns.toml", "config file to use")
